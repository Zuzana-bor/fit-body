...
export const exercises: Exercise[] = [
  {
    ...
    description:
      'S výdechem zvedáme ohýbáním lokte střídavě jednoručky na úroveň ramene',
  ...
  },
  {
    ...
    description:
      'Podepřete se jednou paží o židli. V druhé ruce máte činku, kterou přitahujete k tělu. Zatínáte svaly okolo lopatky a zpět.',
    media: '/assets/single-arm-dumbbell-row.gif',
    category: 'Horní část těla',
  ...
  },
  {
    ...
    name: 'obrácený anděl',
    description:
      'Lehneme si na břicho, nohy máme pár centimetrů od sebe a ruce natažené směrem dopředu. S nádechem nadzvedneme vršek těla lehce nad zem a držíme ho zvedlý. Pohled směřuje vpřed. Natažené ruce začneme pomalým obloukem zapažovat až směrem k nohám. Konečná pozice je těsně vedle nohou. A zpět.',
  ...
  },
  {
    ...
    name: 'Kliky (dámské)',
    description:
      'Výchozí pozice je, že klečíme na kolenou a holeně máme opřené o zem, současně se opřeme o dlaně, vzdálenost by měla být na šířku ramen. Celé tělo by mělo být v rovině. Nepropadejte se mezi lopatkami. Síla by měla vycházet z prsniho svalstva a ramen.',
...

  {
    ...
    description:
      'Stůjte v pozici výpadu (jednoha vpřed), protilehlá ruka drží činku, loket u těla. Předloktí je kolmo k zemi. Paže s činkou jde nahoru tak, aby v konečné pozici byla rovnoběžně s trupem. Následuje chvilková výdrž a vrátíme se do výchozí pozice.',
  ...
  },
  {
    ...
    description:
      'Vezměte dvě jednoručky a zvedněte je k ramenům, dlaně otočte k tělu. Paže jsou skrčené, lokty směřují dopředu.Nadechneme se a s výdechem a souvislým plynulým pohybem zvedněte činky nad hlavu, ne však až do pozice, kde už budou uzamčené a současně otáčejte ruce tak, že se vaše palce budou zatáčet dovnitř, aby na konci pohybu směřovaly vaše dlaně dopředu. Zde na chvilku vydržte a potom s nádechem celý cvik provádějte zpětně až do výchozí pozice.',
...

  {
    ...
    name: 'Sedy-lehy',
    description:
      'Výchozí pozice- leh na zádech, nohy pokrčené s patama u sebe, ruce složené na prsou. Zvedáme se do sedu a vracíme se zpět.',
...

  {
    ...
    description:
      'Začínáme v pozici obráceného prkna. pánev směřuje nahoru. Kolenem pohybujeme směrem k hrudi a zpět. Kolena střídáme.',
  ...
  },
  {
    ...
    name: 'Mrtvý tah',
    description:
      'Postoj je na šíři ramen. Nadechneme se a zpevníme střed těla společně se zádovým svalstvem a zvedneme činky ze země. Držíme je nadhmatem. Začneme pomalu a kontrolovaně klesat směrem k zemi středním tempem, držíme tělo zpevněné. Jakmile dosáhneme spodní polohy, tak s výdechem vyrazíme směrem vzhůru do původní polohy, kde na sekundu zatneme i přední stehna a hýždě pro lepší intenzitu a zapojení daných svalů. S postupným nádechem začneme opět klesat směrem dolů a celý postup opakujeme.',
  ...
  },
  {
    ...
    description:
      'Ležíme na zádech, paže podél těla, nohy pokrčené. S výdechem zvedáme pánev vzhůru, v horní pozici zatneme hýždě, s nádechem se vracíme do výchozí pozice.',
