export const items = [
  ...
  },
  {
    ...
    keys: 'pritahy',
    description:
      'Postavte se s nohama zhruba na vzdálenost boků. Předkloňte se a položte ruce na podlahu před sebe. Nadechněte se a jděte rukama dopředu, jednu po druhé, aby se vaše paty zvedly z podlahy. Jakmile jste v klikové poloze, vraťte se stejným způsobem do výchozí polohy. ',
    media: '.',
    category: 'Horní část těla',
  ...
  {
    name: 'Zdvihání z planku',
    keys: 'zdvihání z planku',
    description:
      'Začněte v pozici planku. Stáhněte břicho. Zvedejte se střídavě na rukou, anižbyste rotovali s bokama ',
    media: '.',
    category: 'Horní část těla',
